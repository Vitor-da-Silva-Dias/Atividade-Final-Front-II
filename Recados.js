...
const myModal = new bootstrap.Modal("#save-errand");

document.getElementById("save-errand").addEventListener("submit", function (e) {
    e.preventDefault()
...
function renderTable() {
    ...
    logged.errands.map((value, index) => {
        ...
        deleteButton.setAttribute("class", `botao-apagar my-1 mx-1`);
        editButton.setAttribute("onclick", `editErrand(${index})`);
        editButton.setAttribute("class", `botao-editar my-1`);
